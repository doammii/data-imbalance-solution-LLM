...
TOX21_URL = "https://chemberta.s3.ap-northeast-2.amazonaws.com/final_dataset/tox21/tox2120.csv"   # public
TOX21_TASKS = ["label"]
# 4 8 12 16 20
...
class _Tox21Loader(_MolnetLoader):
    ...
    def create_dataset(self) -> Dataset:
        dataset_file = os.path.join(self.data_dir, "tox2120.csv") # 수정
