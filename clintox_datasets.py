...
CLINTOX_URL = "https://chemberta.s3.ap-northeast-2.amazonaws.com/final_dataset/clintox/clintox5.csv"   # public
CLINTOX_TASKS = ["label"]
...
class _ClintoxLoader(_MolnetLoader):
    ...
    def create_dataset(self) -> Dataset:
        dataset_file = os.path.join(self.data_dir, "clintox5.csv")  # 수정
...
def load_clintox(
    ...
    splitter: Union[dc.splits.Splitter, str, None] = 'stratified',
